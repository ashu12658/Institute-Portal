...
const TpoAdminDashboard = () => {
  ...
  const validateJobForm = (job) => {
    const requiredFields = ['companyName', 'role', 'location', 'requirements', 'salary'];
  ...
  const handleAddJob = async () => {
    const validationError = validateJobForm(newJob);
    if (validationError) {
  ...
  const handleUpdateJob = async () => {
    const validationError = validateJobForm(selectedJob);
    if (validationError) {
      setError(validationError);
      return;
    }
  ...
  const handleDeleteStudent = async () => {
    ...
    try {
      const token = sessionStorage.getItem('authToken');
      await axios.delete(`http://localhost:5000/api/students/${selectedStudent._id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '15px' }}>
            <motion.button
              ...
              style={{
                padding: '8px 20px',
                background: activeTab === 'applications' ? '#ffffff33' : 'rgba(255,255,255,0.2)',
                border: 'none',
                borderRadius: '30px',
                color: 'white',
                cursor: 'pointer',
            ...
            <motion.button
              ...
              style={{
                padding: '8px 20px',
                background: activeTab === 'jobs' ? '#ffffff33' : 'rgba(255,255,255,0.2)',
                border: 'none',
                borderRadius: '30px',
                color: 'white',
                cursor: 'pointer',
        ...
        <div style={{ padding: '30px', position: 'relative' }}>
          ...
          {toast.message && (
            <motion.div
              ...
              style={{
                ...
                top: '20px',
                right: '20px',
                background: toast.type === 'success' ? '#4CAF50' : '#FF5252',
                color: 'white',
                padding: '15px 20px',
                borderRadius: '8px',
          ...
          {/* Student Selection */}
          <motion.div variants={containerVariants} initial="hidden" animate="visible" style={{ marginBottom: '30px' }}>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ margin: 0, fontWeight: '600' }}>{selectedStudent.course || 'N/A'}</p>
                  </div>
                  <div>
                    <p style={{ margin: '0 0 5px 0', color: '#666', fontSize: '14px' }}>Batch</p>
                    <p style={{ margin: 0, fontWeight: '600' }}>{selectedStudent.batch || 'N/A'}</p>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <p style={{ marginBottom: '25px', color: '#666' }}>
                  Are you sure you want to delete {selectedStudent?.firstName} {selectedStudent?.lastName}? This action
                  cannot be undone.
                </p>
                      ...
                      >
                        ...
                        <div style={{ marginBottom: '15px' }}>
                          <p style={{ margin: '5px 0', color: '#666' }}>
                            <span style={{ fontWeight: '500', color: '#444' }}>Company:</span>{' '}
                            {application.jobId?.companyName || 'N/A'}
                          </p>
                          <p style={{ margin: '5px 0', color: '#666' }}>
                            <span style={{ fontWeight: '500', color: '#444' }}>Location:</span>{' '}
                            {application.jobId?.location || 'N/A'}
                          </p>
                          <p style={{ margin: '5px 0', color: '#666' }}>
                            <span style={{ fontWeight: '500', color: '#444' }}>Salary:</span>{' '}
                      ...
                      {jobs.map((job) => (
                        ...
                        >
                          ...
                          <div style={{ marginBottom: '15px' }}>
                            ...
                            <p style={{ margin: '5px 0', color: '#666' }}>
                              <span style={{ fontWeight: '500', color: '#444' }}>Requirements:</span>{' '}
